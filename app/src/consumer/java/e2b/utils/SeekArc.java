...
//			mEnabled = a.getBoolean(R.styleable.SeekArc_enabled, mEnabled);
            ...
            arcColor = a.getColor(R.styleable.SeekArc_arcColor, res.getColor(R.color.progress_gray));
            progressColor = a.getColor(R.styleable.SeekArc_progressColor, res.getColor(R.color.holo_orange));
